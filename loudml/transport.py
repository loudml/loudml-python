...
def get_host_info(node_info, host):
    ...
    information needs to be provided for the :class:`~loudml.Connection`
...
class Transport(object):
    ...
    def __init__(
        self, hosts, connection_class=Urllib3HttpConnection,
        ...
        :arg connection_class: subclass of :class:`~loudml.Connection` to use
        :arg connection_pool_class: subclass of :class:`~loudml.ConnectionPool` to use
    ...
    def add_connection(self, host):
        """
        Create a new :class:`~loudml.Connection` instance and add it to the pool.
    ...
    def get_connection(self):
        """
        Retreive a :class:`~loudml.Connection` instance from the
        :class:`~loudml.ConnectionPool` instance.
        """
    ...
    def mark_dead(self, connection):
        ...
        :arg connection: instance of :class:`~loudml.Connection` that failed
        """
    ...
    def perform_request(self, method, url, headers=None, params=None, body=None):
        ...
        :arg headers: dictionary of headers, will be handed over to the
            underlying :class:`~loudml.Connection` class
        :arg params: dictionary of query parameters, will be handed over to the
            underlying :class:`~loudml.Connection` class for serialization
